...
onclick="openUpdateModal(
    ...
    '<?php echo htmlspecialchars($row['remarks'],ENT_QUOTES);?>'
        ...
        <a href=""
        onclick="openArchiveModal('<?php echo $row['payment_id']?>'); return false;"> 🗄️ Archive</a>
     </td>
  ...
  <div class="bg-white p-6 rounded-lg shadow-lg w-1/3 relative" onclick="event.stopPropagation()">
    ...
    <form method="post">
      ...
      <div class="flex justify-end space-x-3 mt-4">
        <button type="button" class="px-4 py-2 bg-red-500 text-white  rounded hover:bg-red-600" onclick="closeModal('updateModal')">Cancel</button>
  ...
  <div class="bg-white p-6 rounded-lg shadow-lg w-1/3 relative" onclick="event.stopPropagation()">
    <button class="absolute top-2 right-2 text-gray-500 hover:text-black" onclick="closeModal('archiveModal')">&times;</button>
      ...
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11V6m0 8h.01M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
        ...
        <h2 class="text-lg font-bold mb-4 text-center">Archive Payment</h2>
        <p>Are you sure you want to archive this Payment?</p>
        <form method="post">
